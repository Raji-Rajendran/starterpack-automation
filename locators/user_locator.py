...
class UserLocators:
    ...
    view = By.XPATH, "(//a[@class='v-list-item v-list-item--link v-theme--light v-list-item--density-comfortable v-list-item--one-line v-list-item--variant-text'])[1]"
    delete_btn = By.XPATH, "(//i[@class='v-icon notranslate v-theme--light tabler-trash v-icon notranslate v-theme--light'])[1]"
    ...
    filter_btn = By.XPATH, "(//i[@class='v-icon notranslate v-theme--light v-icon--size-default tabler-filter-edit v-icon notranslate v-theme--light v-icon--size-default'])[1]"
    ...
    filter_close = By.XPATH, "(//i[@class='v-icon notranslate v-theme--light tabler-x v-icon notranslate v-theme--light'])[2]"
